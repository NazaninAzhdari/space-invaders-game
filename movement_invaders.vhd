        ...
        process(i_clk) is
            begin
                if i_reset = '1' then
                    ...
                    for i in pc_INV_ROW3_LIMIT to pc_INV_ROW4_LIMIT -1 then
                        r_invaders(i).X <= pc_X_START_INVS_BORDER + (i- pc_INV_ROW3)*(pc_INV_WIDTH + pc_SPACE);
                    ...
                    ----------------------------
                    for i in 0 to pc_INV_LIMIT -1 then
